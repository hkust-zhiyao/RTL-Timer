...
class Node:
    def __init__(self, name, type, width:None, father:None, value:None):
        self.name = name
        self.type = type
        self.width = width
        self.father = father
...
class Graph:
    ...
    def add_decl_node(self, name, type, width=None, father=None, value=None):
        node = Node(name, type, width, father, value)
        self.node_dict[name] = node

    def graph2pkl(self, design_name, cmd):
        pass
        # folder_dir = './data/graph_data/'
