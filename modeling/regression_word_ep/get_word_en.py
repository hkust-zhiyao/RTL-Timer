...
def run_one_design(design_name):
    ...
    label_dir = f"./pred/sog/{design_name}_word_label.pkl"
    with open (label_dir, "rb") as f:
        label_dict = pickle.load(f)
    ep_set = label_dict.keys()
    ### get ep set ###
    for cmd in cmd_lst:
        label_dir = f"./pred/{cmd}/{design_name}_word_label.pkl"
        with open (label_dir, "rb") as f:
    ...
    for cmd in cmd_lst:
        feat_dir = f"./pred/{cmd}/{design_name}_word_pred.pkl"
